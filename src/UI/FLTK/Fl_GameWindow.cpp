...
{
    if(keyCode >= 'a' && keyCode <= 'z') return Key(keyCode - 32);  // Letters
    if(keyCode >= '0' && keyCode <= '9') return Key(keyCode + 48);  // Numbers
    if(keyCode >= 65361 && keyCode <= 65364) return Key(keyCode - 65324); // Arrows
    if(keyCode >= 65470 && keyCode <= 65481) return Key(keyCode - 65358); // Fn

    // Other keys
    switch(keyCode) {
        case 65288: return Key::Back;
        case 65289: return Key::Tab;
        case 65293: return Key::Enter;
        case 65299: return Key::Pause;
        case 65509: return Key::CapsLock;
        case 65307: return Key::Escape;
        case 32:    return Key::Space;
        case 65365: return Key::PageUp;
        case 65366: return Key::PageDown;
        case 65367: return Key::End;
        case 65360: return Key::Home;
        case 65379: return Key::Insert;
        case 65535: return Key::Delete;
